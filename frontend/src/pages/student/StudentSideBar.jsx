        ...
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Student/subjects">
                    ...
                    <ListItemText primary="Subject Marks" />
                </ListItemButton>
                ...
                <ListItemButton component={Link} to="/Student/fee-payment">
                    <ListItemIcon>
                        <PaymentIcon color={location.pathname.startsWith("/Student/fee-payment") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                    <ListItemText primary="Fee Payment" />
                </ListItemButton>

                {/* Placement */}
                <ListItemButton component={Link} to="/Student/placementdrive">
                    <ListItemIcon>
                        <WorkIcon color={location.pathname.startsWith("/Student/placement") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
